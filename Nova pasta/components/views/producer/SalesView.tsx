...
const SalesView: React.FC = () => {
    ...
    const handleAddOffer = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setNewOffer({ product: '', quantity: '', price: '', channel: newOffer.channel });
        } catch {
    ...
    return (
        <div>
            <h2 className="text-3xl font-bold text-slate-800 mb-2">Venda Mercado Consumidor</h2>
            <p className="text-slate-600 mb-8">Crie ofertas para Atacadista Direto e Mercados.</p>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleAddOffer} className="space-y-4">
                            <div>
                                ...
                                <input type="text" name="product" id="product" value={newOffer.product} onChange={handleInputChange} className="mt-1 w-full p-2 border border-slate-300 rounded-md" placeholder="Ex: Soja em Graos" />
                            </div>
                            <div>
                            ...
                            <div>
                                <label htmlFor="price" className="block text-sm font-medium text-slate-700">Preco (Unitario)</label>
                            ...
                            <table className="w-full text-sm text-left">
                                <thead className="text-xs text-slate-700 uppercase bg-slate-100">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3">Subcanal</th>
                                ...
                                <tbody>
                                    {offers.map((offer) => (
                                        <tr key={offer.id} className="border-b last:border-b-0 hover:bg-slate-50">
                                            ...
                                            <td className="px-6 py-4">{channelLabel(offer.channel)}</td>
