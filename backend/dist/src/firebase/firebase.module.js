...
exports.FirebaseModule = FirebaseModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [firebase_admin_service_1.FirebaseAdminService, firestore_service_1.FirestoreService],
        exports: [firebase_admin_service_1.FirebaseAdminService, firestore_service_1.FirestoreService],
    })
], FirebaseModule);
